export default function Hero() {
  return (
    <section id="home" className="bg-white py-20 md:py-28 text-center border-b border-black/8">
      <div className="max-w-[1200px] mx-auto px-6">
        <h1 className="font-headline text-[clamp(64px,12vw,160px)] leading-[0.88] text-[#0A0A0A] tracking-tight">
          MASUM GANDHI
        </h1>

        <p className="mt-6 text-[11px] font-semibold tracking-[0.22em] uppercase text-[#888]">
          India&apos;s First Trigger-Question Podcast
        </p>

        <p className="mt-4 max-w-lg mx-auto text-[15px] leading-relaxed text-[#888]">
          Conversations with founders, healthcare experts, creators, and industry leaders that uncover real stories.
        </p>

        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <a
            href="https://open.spotify.com/show/masumgandhi"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-[13px] font-semibold text-[#0A0A0A] border border-black/20 px-5 py-2.5 rounded-full hover:border-primary transition-colors"
          >
          ...
          <a
            ...
            className="flex items-center gap-2 text-[13px] font-semibold text-[#0A0A0A] border border-black/20 px-5 py-2.5 rounded-full hover:border-primary transition-colors"
          >
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="url(#ig-grad)"><defs><linearGradient id="ig-grad" x1="0%" y1="100%" x2="100%" y2="0%"><stop offset="0%" stopColor="#f09433"/><stop offset="25%" stopColor="#e6683c"/><stop offset="50%" stopColor="#dc2743"/><stop offset="75%" stopColor="#cc2366"/><stop offset="100%" stopColor="#bc1888"/></linearGradient></defs><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324zM12 16a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm6.406-11.845a1.44 1.44 0 1 0 0 2.881 1.44 1.44 0 0 0 0-2.881z"/></svg>
            Instagram
          </a>
        </div>
      </div>
