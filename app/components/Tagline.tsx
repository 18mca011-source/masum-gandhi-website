export default function Tagline() {
  return (
    <section style={{ background: "#e8e8e8", padding: "64px 24px", textAlign: "center" }}>
      <p style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(22px, 3.5vw, 36px)", fontWeight: 700, color: "#111", lineHeight: 1.4, maxWidth: 760, margin: "0 auto", textWrap: "balance" as const }}>
